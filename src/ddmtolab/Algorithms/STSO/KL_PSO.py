...
References
----------
    [1] Jiang, Y., Zhan, Z. H., Tan, K. C., & Zhang, J. (2023). Knowledge Learning for Evolutionary Computation. IEEE Transactions on Evolutionary Computation. DOI: 10.1109/TEVC.2023.3278132
...
class KL_PSO:
    ...
    def __init__(self, problem, n=None, max_nfes=None, lr=0.2, epochs=10,
                 ...
                 save_data=True, save_path='./Data', name='KL-PSO', disable_tqdm=True):
        """
